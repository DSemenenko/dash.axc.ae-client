    ...
    <div class="blog-slider__wrp swiper-wrapper">
      <div class="blog-slider__item swiper-slide">
        ...
        <div class="blog-slider__content">
          ...
          <div class="blog-slider__title"><span class="avatar" style={{background: "#33691e"}}>A</span>Adelina Zelenskaia</div>
          <div class="date-star">
            <div class="stars">
      ...
      <div class="blog-slider__item swiper-slide">
        <div class="blog-slider__img">
          <img src="https://upload-5b6ed3f1470f864e3426fe4c1fe063ed.s3.amazonaws.com/main/590/59009ada368bc26c5182f1d9599c850b/Vadim_Sarandi.jpg" alt=""/>
        </div>
        <div class="blog-slider__content">
          {/* <!-- <span class="blog-slider__code">26 December 2019</span> --> */}
          <div class="blog-slider__title"><span class="avatar" style="background: #2588d1;">M</span>Михаил Лазаренко</div>
          <div class="date-star">
            <div class="stars">
              <i class="fas fa-star"></i>
              <i class="fas fa-star"></i>
      ...
      <div class="blog-slider__item swiper-slide">
        ...
        <div class="blog-slider__content">
          {/* <!-- <span class="blog-slider__code">26 December 2019</span> --> */}
          <div class="blog-slider__title"><span class="avatar" style={{background: "#ab47bd"}}>Я</span>ЯВ Чунаковы</div>
          <div class="date-star">
            <div class="stars">
              <i class="fas fa-star"></i>
              <i class="fas fa-star"></i>
